...
export default function EngineControls({ params, onChange }: EngineControlsProps) {
  ...
  const icons = {
    ...
    gauge: (
      <svg width="16" height="16" viewBox="0 0 256 256" fill="currentColor">
        <path d="M232,136a104.28,104.28,0,0,1-19,59.21,8,8,0,0,1-13.2-9A88.24,88.24,0,0,0,216,136a88,88,0,0,0-176,0,88.24,88.24,0,0,0,16.19,50.21,8,8,0,0,1-13.2,9A104.28,104.28,0,0,1,24,136a104,104,0,0,1,208,0Zm-56.59-36.29A8,8,0,0,0,164.29,110L143,134.22A23.65,23.65,0,0,0,128,128a24,24,0,1,0,24,24,23.65,23.65,0,0,0-6.22-15l21.29-24.2A8,8,0,0,0,175.41,99.71Z"/>
      </svg>
    ),
  };
